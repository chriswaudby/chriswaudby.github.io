---
title: "NMR sensitivity enhancement and homonuclear decoupling using non-uniform weighted sampling"
collection: publications
permalink: /publication/2020-03-19-nmr-sensitivity
#excerpt: 'This paper is about the number 1. The number 2 is left for future work.'
date: 2020-03-19
venue: 'chemRxiv'
paperurl: 'http://academicpages.github.io/files/paper1.pdf'
citation: 'Waudby, C. & Christodoulou, J. NMR resolution enhancement and homonuclear decoupling using non-uniform weighted sampling. <i>chemRxiv</i> (2020)'
---
...
[Download paper here](https://chemrxiv.org/articles/preprint/NMR_Resolution_Enhancement_and_Homonuclear_Decoupling_Using_Non-Uniform_Weighted_Sampling/12006750/1)

Recommended citation: Waudby, C. & Christodoulou, J. NMR resolution enhancement and homonuclear decoupling using non-uniform weighted sampling. <i>chemRxiv</i> (2020).
